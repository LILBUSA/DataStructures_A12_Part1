...
public class Prims<V> extends AbstractGraph<V> {
    /**
     * Construct an empty
     */
    public Prims() {
     ...
     */
    public Prims(V[] vertices, int[][] edges) {
     ...
     */
    public Prims(int[][] edges, int numberOfVertices) {
     ...
     */
    public Prims(List<V> vertices, List<WeightedEdge> edges) {
        createWeightedGraph(vertices, edges);
    }
     ...
     */
    public Prims(List<WeightedEdge> edges, int numberOfVertices) {
        List<V> vertices = new ArrayList<>();
        for (int i = 0; i < numberOfVertices; i++)
            vertices.add((V) (new Integer(i)));
